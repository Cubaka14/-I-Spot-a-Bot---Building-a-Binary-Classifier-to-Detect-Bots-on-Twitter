...
list_bot_pandas.append(pd.read_csv(r"C:\Users\Nemanja.Antic\Desktop\iSpotABot\cresci-2015\E13\users.csv"))
list_bot_pandas.append(pd.read_csv(r"C:\Users\Nemanja.Antic\Desktop\iSpotABot\cresci-2015\E13\users.csv"))
bots = pd.concat(list_bot_pandas)
bots['is_bot'] = 1

cresci2015_users = pd.concat([humans,bots])
...
list_humans_pandas_2.append(pd.read_csv('cresci-2015/E13/tweets.csv'))
list_humans_pandas_2.append(pd.read_csv('cresci-2015/TFP/tweets.csv'))
humans_2 = pd.concat(list_humans_pandas_2)

list_bot_pandas_2 = []
list_bot_pandas_2.append(pd.read_csv('cresci-2015/FSF/tweets.csv'))
list_bot_pandas_2.append(pd.read_csv('cresci-2015/INT/tweets.csv'))
list_bot_pandas_2.append(pd.read_csv('cresci-2015/TWT/tweets.csv'))
